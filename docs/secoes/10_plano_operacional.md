...
O serviço segue a metodologia ágil Scrum. A Diretoria Executiva e de Produto levanta os requisitos com o professor/escola e desenha os protótipos. Após aprovação visual, a Diretoria de Engenharia codifica a solução, realiza os testes técnicos e, junto ao professor orientador, faz o code review antes de hospedar a solução em nuvem.
